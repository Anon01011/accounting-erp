        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800">Create Tax Rate</h2>
                ...
                <form action="{{ route('settings.tax.rates.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="rate" id="rate" value="{{ old('rate') }}" step="0.01" min="0" max="999.99"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#01657F] focus:ring focus:ring-[#01657F] focus:ring-opacity-50"
                                   required>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="3" 
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#01657F] focus:ring focus:ring-[#01657F] focus:ring-opacity-50">{{ old('description') }}</textarea>
                        </div>
                    </div>

...
<div class="max-w mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="bg-white shadow rounded-lg">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Create Tax Group</h2>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('settings.tax.groups.store') }}" method="POST" autocomplete="off" class="tax-group-form" id="taxGroupForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input type="text" name="code" id="code" value="GRP-{{ str_pad((App\Models\TaxGroup::count() + 1), 3, '0', STR_PAD_LEFT) }}" readonly 
                ...
                <div class="mt-6 flex justify-end">
                    <button type="submit" class="inline-flex items-center px-4 py-2 bg-[#01657F] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#014d61] focus:bg-[#014d61] active:bg-[#013d4d] focus:outline-none focus:ring-2 focus:ring-[#01657F] focus:ring-offset-2 transition ease-in-out duration-150">
                        <i class="fas fa-save mr-2"></i> Create Tax Group
                    </button>
                </div>
            </form>
        </div>
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data && data.success) {
                toastr.success('Tax group created successfully');
                setTimeout(() => {
        ...
        .catch(error => {
            ...
            toastr.error(error.message || 'An error occurred while saving the tax group');
        });
    });

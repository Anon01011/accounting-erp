                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                <a href="#" class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-150">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-medium text-gray-500">Balance Trend</span>
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-medium text-gray-500">Transaction Frequency</span>
                                    <span class="text-sm font-semibold text-blue-600">Regular</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
...
<a href="{{ route('chart-of-accounts.show', ['chart_of_account' => $related->id]) }}" class="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-150">
                <div class="flex justify-between items-center">
                    <span class="text-sm font-medium text-gray-900">{{ $related->name }}</span>
                    <span class="text-sm text-gray-500">{{ $related->account_code }}</span>
                </div>
            </a>
        @endforeach
    @else
        <p class="text-sm text-gray-500 italic">No related accounts with journal entries found.</p>
    @endif
</div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-md transition-colors duration-150">
                                View All Entries
                        ...
                        @else
                            <div class="text-center py-12 bg-gray-50 rounded-lg">
                                ...
                                <div class="mt-6">
                                    <a href="#" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-150">

...
<div class="py-4">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-lg p-6">
            <h1 class="text-3xl font-bold text-gray-900 mb-6">Add New Currency</h1>
            ...
            <form action="{{ route('currencies.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.0001" name="exchange_rate" id="exchange_rate" value="{{ old('exchange_rate') }}" required
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#01657F] focus:border-transparent">
                    @error('exchange_rate')
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit" class="px-4 py-2 bg-[#01657F] rounded text-white font-semibold hover:bg-[#014d61]">Add Currency</button>
                </div>
            </form>
        </div>
    </div>

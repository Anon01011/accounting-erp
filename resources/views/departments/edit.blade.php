...
<div class="py-4">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-lg p-6">
            <h1 class="text-3xl font-bold text-gray-900 mb-6">Edit Department</h1>
            ...
            <form action="{{ route('departments.update', $department) }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="status" class="inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="status" id="status" value="1" {{ $department->status ? 'checked' : '' }}
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit" class="px-4 py-2 bg-[#01657F] rounded text-white font-semibold hover:bg-[#014d61]">Update Department</button>
                </div>
            </form>
        </div>
    </div>

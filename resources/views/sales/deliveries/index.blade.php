...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('sales.deliveries.create') }}" class="bg-theme-color text-white px-4 py-2 rounded-lg hover:bg-theme-hover">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex space-x-4">
                    <div class="relative">
                        <input type="text" placeholder="Search deliveries..." class="w-64 pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:border-theme-color">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">DEL-001</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">SO-001</td>

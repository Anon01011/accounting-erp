...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('sales.categories.create') }}" class="bg-theme-color text-white px-4 py-2 rounded-lg hover:bg-theme-hover">
        ...
        <div class="p-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex space-x-4">
                    <div class="relative">
                        <input type="text" placeholder="Search categories..." class="w-64 pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:border-theme-color">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-sm text-gray-500">ID: CAT-001</div>
                            </div>
                        </div>
                    </td>

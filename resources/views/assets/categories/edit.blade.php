                ...
                <form action="{{ route('assets.categories.update', $category) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="w-full px-4 py-2 border border-[#1b758c] rounded-lg focus:outline-none focus:border-[#1b758c] focus:ring focus:ring-[#1b758c] focus:ring-opacity-30 transition-colors duration-200">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <select id="depreciation_method" name="depreciation_method" class="w-full h-12 px-4 py-2 border border-[#1b758c] rounded-lg focus:outline-none focus:border-[#1b758c] focus:ring focus:ring-[#1b758c] focus:ring-opacity-30 transition-colors duration-200" required>
                                ...
                                <option value="declining_balance" {{ old('depreciation_method', $category->depreciation_method) == 'declining_balance' ? 'selected' : '' }}>Declining Balance</option>
                                <option value="sum_of_years" {{ old('depreciation_method', $category->depreciation_method) == 'sum_of_years' ? 'selected' : '' }}>Sum of Years Digits</option>
                                <option value="units_of_production" {{ old('depreciation_method', $category->depreciation_method) == 'units_of_production' ? 'selected' : '' }}>Units of Production</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input id="default_depreciation_rate" name="default_depreciation_rate" type="number" step="0.01" min="0" max="100" class="w-full h-12 px-4 py-2 border border-[#1b758c] rounded-lg focus:outline-none focus:border-[#1b758c] focus:ring focus:ring-[#1b758c] focus:ring-opacity-30 transition-colors duration-200" value="{{ old('default_depreciation_rate', $category->default_depreciation_rate) }}" required />
                        ...
                        <div>
                            ...
                            <input id="default_useful_life" name="default_useful_life" type="number" min="1" class="w-full h-12 px-4 py-2 border border-[#1b758c] rounded-lg focus:outline-none focus:border-[#1b758c] focus:ring focus:ring-[#1b758c] focus:ring-opacity-30 transition-colors duration-200" value="{{ old('default_useful_life', $category->default_useful_life) }}" required />
